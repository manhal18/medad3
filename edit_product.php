<?php
    ...
    if ($result->num_rows > 0) {
        ...
        $favorite = ($row["favorite_product"] == 1) ? "checked" : 0;
        $errors = [];
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if($_FILES['image']['name'] != ""){
                ...
                if ($uploadOk == 1){
                    // Use unlink() function to delete the updated image
            ...
            if(empty($errors)){
                ...
                $sql = "UPDATE `products` SET `product_name`='$name', `price` = '$price', `description` = '$description', `image` = '$image_name', `favorite_product` = '$favorite' WHERE id=$id";
...
<body>
    ...
    <form method="POST" enctype="multipart/form-data" class="w-50 m-auto">
        ...
        <div class="mb-3">
            <textarea class="form-control" rows="3" placeholder="Description" name="description" id="description">
        ...
        <div class="mb-3">
            <lable class="text-primary">If no image is selected, the product image will not be updated.</lable>
        ...
        <div class="form-check text-start my-3">
          <input class="form-check-input" type="checkbox" name="favorite" <?= htmlspecialchars($favorite) ?>>
